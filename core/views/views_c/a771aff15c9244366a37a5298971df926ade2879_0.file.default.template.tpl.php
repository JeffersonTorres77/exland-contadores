<?php
/* Smarty version 3.1.36, created on 2020-10-26 22:53:52
  from 'C:\xampp\htdocs\contaduria\core\views\default.template.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5f97457076e789_93233748',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a771aff15c9244366a37a5298971df926ade2879' => 
    array (
...
function content_5f97457076e789_93233748 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <!-- HEADER -->
    <header class="navbar encabezado bg-success">
        <a class="navbar-brand" href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
">
            <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
/public/core/img/logo.png" height="30" alt="Logo Exland">
        </a>

        <div>
            <div class="header-option">
                <button class="btn btn-success" onclick="switchMenuLateral()">
                    <i class="fas fa-bars"></i>
                </button>
            </div>

            <div class="header-option">
                <button class="btn btn-success dropdown-toggle" data-toggle="collapse" data-target="#user-options">
        ...
        <div class="row flex-xl-nowrap" menu-lateral="false">
            ...
            <div class="border-right menu-lateral bg-light" id="menu-lateral">
                ...
                <div class="lista-menu" id="group-menu">
                    <div class="menu-separator bg-success text-white">
