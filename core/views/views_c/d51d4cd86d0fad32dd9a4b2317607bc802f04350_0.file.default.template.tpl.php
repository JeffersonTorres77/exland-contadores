<?php
/* Smarty version 3.1.36, created on 2021-04-19 16:43:02
  from 'C:\xampp\htdocs\Contaduria\core\views\default.template.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_607d96f616aa74_59146188',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd51d4cd86d0fad32dd9a4b2317607bc802f04350' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Contaduria\\core\\views\\default.template.tpl',
      1 => 1616625888,
      2 => 'file',
    ),
  ),
...
function content_607d96f616aa74_59146188 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <!-- HEADER -->
    <header class="navbar encabezado" style="background-color: #4db350;">
...
/public/core/img/logo.png" height="45" alt="Logo Exland">
        ...
        <div>
            <div class="header-option">
                <button class="btn btn-success" style="background-color: #4db350 !important;" onclick="switchMenuLateral()">
                    <i class="fas fa-bars"></i>
                </button>
            </div>

            <div class="header-option">
                <button class="btn btn-success dropdown-toggle" style="background-color: #4db350 !important;" data-toggle="collapse" data-target="#user-options">
        ...
        <div class="row flex-xl-nowrap" menu-lateral="false">
            ...
            <div class="border-right menu-lateral bg-light" id="menu-lateral">
                ...
                <div class="lista-menu" id="group-menu">
                    <div class="menu-separator text-white" style="background-color: #4db350;">
...
/Dashboard/">
                    ...
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['templateMenus']->value, 'menus', false, 'seccion');
