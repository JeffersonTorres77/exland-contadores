<?php
/* Smarty version 3.1.36, created on 2021-07-20 21:26:18
  from 'C:\xampp\htdocs\Contadores\app\facturas\templates\ver.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_60f7235a726ed4_50583458',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '80e7dea67c6f9415a5bdec807bcefdcfd6592876' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Contadores\\app\\facturas\\templates\\ver.tpl',
      1 => 1626809177,
      2 => 'file',
    ),
  ),
...
function content_60f7235a726ed4_50583458 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\xampp\\htdocs\\Contadores\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
echo '<script'; ?>
>
    const ID_FACTURA = '<?php echo $_smarty_tpl->tpl_vars['objFactura']->value->id;?>
';
    const COBROS_ADICIONALES_DINAMICOS = JSON.parse(`<?php echo json_encode($_smarty_tpl->tpl_vars['cobros_adicionales_dinamicos']->value);?>
`);
    const COBROS_ADICIONALES_ESTATICOS = JSON.parse(`<?php echo $_smarty_tpl->tpl_vars['cobros_adicionales_estaticos']->value;?>
`);
    const VALOR_PLAN = `<?php echo $_smarty_tpl->tpl_vars['objFactura']->value->planValue;?>
`;
    const STATUS_FACTURA = JSON.parse(`<?php echo json_encode($_smarty_tpl->tpl_vars['objStatus']->value);?>
`);
<?php echo '</script'; ?>
>
...
">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select name="periodoCobro" id="input-periodoCobro" class="form-control form-control-sm" <?php echo $_smarty_tpl->tpl_vars['objFactura']->value->idStatus == '1' || $_smarty_tpl->tpl_vars['objFactura']->value->idStatus == '2' ? 'required' : 'disabled';?>
>
                            <option value="">Seleccione el periodo de cobro...</option>
                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['periodosCobros']->value, 'periodo');
...
?>
                                <?php if ($_smarty_tpl->tpl_vars['objPeriodo']->value->id == $_smarty_tpl->tpl_vars['periodo']->value['idPeriodoContable']) {?>
                                    <option value="<?php echo $_smarty_tpl->tpl_vars['periodo']->value['idPeriodoContable'];?>
" selected><?php echo $_smarty_tpl->tpl_vars['periodo']->value['nombre'];?>
</option>
                                <?php } else { ?>
                                    <option value="<?php echo $_smarty_tpl->tpl_vars['periodo']->value['idPeriodoContable'];?>
