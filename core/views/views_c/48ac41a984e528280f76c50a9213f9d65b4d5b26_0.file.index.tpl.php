<?php
/* Smarty version 3.1.36, created on 2020-10-20 03:40:55
  from 'C:\xampp\htdocs\contaduria\app\bancos\templates\index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5f8e4027d2e052_12727815',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '48ac41a984e528280f76c50a9213f9d65b4d5b26' => 
    array (
      0 => 'C:\\xampp\\htdocs\\contaduria\\app\\bancos\\templates\\index.tpl',
      1 => 1603158055,
      2 => 'file',
    ),
  ),
...
function content_5f8e4027d2e052_12727815 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="p-2 m-2">
    <div class="card">
...
<div class="modal fade" id="modal-editar">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <form class="modal-content" id="form-editar">
            <input type="hidden" name="idBanco" id="editar-input-idBanco">

            <div class="modal-header bg-success text-white">
                <h5 class="mb-0">Modificar banco</h5>
                <button class="close" data-dismiss="modal">&times;</button>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <form class="modal-content" id="form-eliminar">
            <div class="modal-header bg-danger text-white">
                <h5 class="mb-0">Eliminar banco</h5>
                <button class="close" data-dismiss="modal">&times;</button>
            </div>

            <div class="modal-body">
                <input type="hidden" name="idBanco" id="eliminar-input-idBanco">
                <label>¿Esta seguro que desea eliminar el banco <b id="eliminar-label-nombre"></b>?</label>
            </div>
